...
/*
 * Op mode for computing kV, kStatic, and kA from various org.firstinspires.ftc.teamcode.roadrunner.drive routines. For the curious, here's an
    ...
    public void runOpMode() throws InterruptedException {
        if (RUN_USING_ENCODER) {
            RobotLog.setGlobalErrorMsg("Feedforward constants usually don't need to be tuned " +
                    "when using the built-in org.firstinspires.ftc.teamcode.roadrunner.drive motor velocity PID.");
        }
