...
import org.firstinspires.ftc.teamcode.roadrunner.drive.advanced.TrajectorySequenceRunnerCancelable;
...
/*
 * Simple mecanum org.firstinspires.ftc.teamcode.roadrunner.drive hardware implementation for REV hardware.
 */
@Config
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public void followTrajectory(Trajectory trajectory) {
        ...
        setPoseEstimate(trajectory.end());
        waitForIdle();
    }
    ...
    public void setWeightedDrivePower(Pose2d drivePower) {
        ...
        float[] sum = PaulMath.omniCalc((float) vel.getX(),(float) vel.getY(),(float) vel.getHeading());
        setMotorPowers(sum[0], sum[1], sum[2], sum[3]);
    }
