...
import dev.autoauto.runtime.values.prototype.universal.UniversalPrototype;
import dev.autoauto.runtime.errors.AutoautoNameException;
import org.jetbrains.annotations.NotNull;

import java.util.HashMap;

public abstract class AutoautoValue implements AutoautoPropertyBearingObject, AutoautoProgramElement {

    public final static AutoautoValue[] EMPTY_ARRAY = new AutoautoValue[0];

    public AutoautoValue() {
    ...
    public AutoautoValue getProperty(AutoautoValue key) {
        ...
        if(descriptor.getter != null) return descriptor.getter.call(this, new AutoautoValue[0]);

        //if there's no getter, get the value directly.
        //return undefined instead of a null.
        AutoautoValue value = descriptor.value;
    ...
    public void setProperty(AutoautoValue key, AutoautoValue value) {
        ...
        else if(descriptor.setter != null) descriptor.setter.call(this, new AutoautoValue[] {value});
    ...
    public void setPrototype(AutoautoValue p) {
