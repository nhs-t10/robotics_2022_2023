...
import dev.autoauto.runtime.nativefunctions.AutoautoMathMethodsTable;
import dev.autoauto.runtime.nativefunctions.TypeofFunction;
import dev.autoauto.runtime.nativefunctions.ProvideFunction;
import dev.autoauto.runtime.nativefunctions.LogFunction;
import dev.autoauto.runtime.nativefunctions.ReturnFunction;
...
public class AutoautoRuntimeVariableScope {
    ...
    public void put(String s, AutoautoValue v) {
    ...
    @Nullable
    public AutoautoValue get(String s) {
    ...
    public void systemSet(String s, AutoautoValue v) {
    ...
    public void initStandaloneBuiltins() {
    ...
    public void initBuiltinFunctions(RobotFunctionLoader robotFunctions) {
        initStandaloneBuiltins();
